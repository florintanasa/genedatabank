...
@JmixEntity
@Table(name = "ZONESIRUTA", uniqueConstraints = {
        @UniqueConstraint(name = "IDX_ZONESIRUTA_UNQ_SIRUTA", columnNames = {"SIRUTA"}),
        @UniqueConstraint(name = "IDX_ZONESIRUTA_UNQ_ZONENAME", columnNames = {"ZONENAME"}),
        @UniqueConstraint(name = "IDX_ZONESIRUTA_UNQ_ZONENUMBER", columnNames = {"ZONENUMBER"})
})
@Entity
public class Zonesiruta {
    @JmixGeneratedValue
