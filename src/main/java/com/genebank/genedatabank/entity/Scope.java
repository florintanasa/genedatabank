...
@JmixEntity
@Table(name = "SCOPE_", uniqueConstraints = {
        @UniqueConstraint(name = "IDX_SCOPE_UNQ_CODESPEC", columnNames = {"CODESPEC"}),
        @UniqueConstraint(name = "IDX_SCOPE_UNQ_NAME", columnNames = {"NAME"})
})
@Entity(name = "Scope_")
public class Scope {
    @JmixGeneratedValue
    ...
    @NotNull
    @Column(name = "CODESPEC", nullable = false)
