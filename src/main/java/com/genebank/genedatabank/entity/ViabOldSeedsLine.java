...
@JmixEntity
@Table(name = "VIAB_OLD_SEEDS_LINE", indexes = {
        @Index(name = "IDX_VIAB_OLD_SEEDS_LINE_VIAB_OLD_SEEDS", columnList = "VIAB_OLD_SEEDS_ID")
})
@Entity
public class ViabOldSeedsLine {
    @JmixGeneratedValue
    ...
    @JoinColumn(name = "VIAB_OLD_SEEDS_ID")
    ...
    public ViabOldSeeds getViabOldSeeds() {
        return viabOldSeeds;
    }

    public void setViabOldSeeds(ViabOldSeeds viabOldSeeds) {
        this.viabOldSeeds = viabOldSeeds;
    }
    ...
    @InstanceName
    @DependsOnProperties({"viabOldSeeds", "germTestNum"})
    public String getInstanceName(MetadataTools metadataTools, DatatypeFormatter datatypeFormatter) {
        return String.format("%s - %s",
                metadataTools.format(viabOldSeeds),
                datatypeFormatter.formatInteger(germTestNum));
    }
}